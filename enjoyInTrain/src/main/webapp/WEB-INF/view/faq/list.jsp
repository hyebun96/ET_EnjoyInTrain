									...
									<tr id="question" data-num="${dto.faqNum}" height="35"
										...
										<td style="padding: 5px 0px;">&nbsp;&nbsp;<i class="fas fa-question-circle"></i>&nbsp;&nbsp;${dto.faqTitle}
											...
											<c:if test="${sessionScope.crew.crewId=='a'}">
												<button type="button" id="deletebtn" class="btn" onclick="javascript:location.href='<%=cp%>/faq/delete?num=${dto.faqNum}';">
													<i class="fas fa-trash-alt"></i>
												</button>
												<button type="button" id="updatebtn" class="btn" onclick="javascript:location.href='<%=cp%>/faq/update?num=${dto.faqNum}';">
							...
							<tr height="35">
								...
								<c:if test="${sessionScope.crew.crewId=='a'}">
									<button style="border-radius: 10px;" type="button" id="btn"
										class="btn"
										onclick="javascript:location.href='<%=cp%>/faq/created?group=${group}'">FAQ올리기</button>
								</c:if></td>
							</tr>
						</table>
