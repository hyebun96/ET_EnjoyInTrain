...
function articleForm(num) {
	...
	var url="<%=cp%>/admin/travel/article";
		...
		<div class="row">
			<div class="9u skel-cell-important">
				<section>
					<header>
						<h2>여행 프로모션</h2>
						<span class="byline">Travel Promotion<button style="border-radius: 10px; float: right;" type="button" id="btn" class="btn" onclick="insertForm();">프로모션 추가</button></span>
					</header>
