				...
				<section>
					...
					<div>		
						<div style="clear: both;">
							<ul class="tabs">
								<li id="tab-1" data-emcheck="1">기차시간</li>
								<li id="tab-0" data-emcheck="0">기차등록</li>
							</ul>
						</div>
			   			...
			   			<tr height="40">
							...
							<td align="center">
								<form name="searchForm" action="<%=cp%>/employee/list" method="post">
									<button type="button" class="btn1" onclick="javascript:location.href='<%=cp%>/admin/timeTable/list';">새로고침</button>
							...
							<td align="right" width="100">
								<button type="button" class="btn" onclick="javascript:location.href='<%=cp%>/admin/timeTable/create';">등록</button>
							</td>
							</tr>
						</table>
