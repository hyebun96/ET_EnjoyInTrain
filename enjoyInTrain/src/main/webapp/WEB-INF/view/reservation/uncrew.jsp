								...
								<div style="width: 1200px; text-align: center;">
								 	<table style="width:100%;  ">
								 		<tr style="height:40px;  border-top: 2px solid black;">
								 			<td style="width:200px; background:#EAEAEA;"><b>성명</b></td>
								 			<td style="text-align: left;"><input id="name" name="name" style="margin: 5px;" type="text"></td>
								 		</tr>
								 		<tr style="height:40px;">
								 			<td style="background:#EAEAEA;"><b>전화번호</b></td>
								 		...
								 		<tr style="height:40px;">
								 			<td style="background:#EAEAEA;"><b>비밀번호 확인</b></td>
