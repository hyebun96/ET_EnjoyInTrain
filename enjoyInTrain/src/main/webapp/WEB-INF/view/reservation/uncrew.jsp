								...
								<div style="width: 1200px; text-align: center;">
								 	<table style="width:100%;  ">
								 		<tr style="height:40px;  border-top: 2px solid black;">
								 			<td style="width:200px; background:#08298A;"><b style="color: white;">성명</b></td>
								 			<td style="text-align: left;"><input id="name" name="name" style="margin: 5px;" type="text"></td>
								 		</tr>
								 		<tr style="height:40px;">
								 			<td style="background:#08298A;"><b style="color: white;">전화번호</b></td>
								 		...
								 		<tr style="height:40px;">
								 			<td style="background:#08298A;"><b style="color: white;">이메일</b></td>
								 			<td style="text-align: left;"><input id="email" name="email" type="text" style="width:300px; margin: 5px;"></td>
								 		</tr>
								 		<tr style="height:40px;">
								 			<td style="background:#08298A;"><b style="color: white;">비밀번호</b></td>
								 			<td style="text-align: left;"><input id="password" maxlength="5" name="password" style="margin: 5px;" type="password">※ 발권조회 확인용 숫자 5자리를 입력하세요.</td>
								 		</tr>
								 		<tr style="height:40px;">
								 			<td style="background:#08298A;"><b style="color: white;">비밀번호 확인</b></td>
								 			<td style="text-align: left;"><input id="password2" maxlength="5" style="margin: 5px;" type="password"></td>
								 		</tr>
								 	</table>
								 	...
								 	<br>
								 	<button type="button" onclick="unCrewBtn()" style="font-weight:bold; font-size:15px; border-radius:5px; width:100px; height:30px; background: #08298A; color: white; border: none;">확인</button>
								</div>
