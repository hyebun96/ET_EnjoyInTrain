...
<div id="myModal2" class="modal">
  <!-- Modal content -->
  <div style="background: #273267;" class="modal-content2" id="modal-content2">
...
<div id="myModal3" class="modal">
  <!-- Modal content -->
  <div style="background: #273267;" class="modal-content3" id="modal-content3">
...
<div id="myModal4" class="modal">
  <!-- Modal content -->
  <div style="background: #273267;" class="modal-content4" id="modal-content4">
...
<table class="timetb" style="text-align:center; border:1px solid #D5D5D5; font-size: 13px;">
	<tr>
		<td style="text-align:left; background: #e8e8e8;" colspan="12"><b>· ${rsDto.startSt}->${rsDto.endSt} ${rsDto.day}</b></td>
	</tr>
	<tr>
	...
	<c:forEach var="dto" items="${list}">
		<tr>
			...
			<td>
				...
				<c:if test="${sw}">
					<button class="reservationBtn" value="special" style="border:none; background: #273267; color: white;">예약하기</button><br>
					<button class="seatBtn" value="special" type="button" style="border:none; background: #ddd; color:black;">좌석선택</button>
				</c:if>
			</td>
			<td>
				<c:set var="sw" value="true"/>
				...
				<c:if test="${sw}">
					<button class="reservationBtn" value="general" style="border:none; background: #273267; color: white;">예약하기</button><br>
					<button class="seatBtn" value="general" type="button" style="border:none; background: #ddd; color:black;">좌석선택</button>
				</c:if>
			</td>
			<td>
