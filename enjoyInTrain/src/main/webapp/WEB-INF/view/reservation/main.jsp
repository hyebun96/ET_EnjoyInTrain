								...
								<div style="width: 1200px; ">
									<div style="width: 100%; ">
										<ul class="tabs" style="font-size:17px; text-align:center; width: 100%; border:1px solid #D5D5D5;">
											<li style="background:#44565B; color:white; border-right: 1px solid #D5D5D5; line-height:40px; height:40px; width:100%; float: left">승차권 조회</li>
										</ul>
												...
												<td colspan="3" >
													<div>
														...
														<div style="float: left; margin-right: 10px;" >
															...
															<button type="button" class="myBtn" style="border:none; background: #44565B;" >
																<i class="fas fa-map-marker-alt" style="margin:4px; font-size: 17px; color: white;"></i>
															</button>
														</div>
									...
									<div style="text-align: center; ">
										<button type="button" onclick="listPage(1);" style="font-weight:bold; font-size:15px; border-radius:5px; width:100px; height:30px; background: #44565B; color: white; border: none;">조회하기</button>
									</div>
