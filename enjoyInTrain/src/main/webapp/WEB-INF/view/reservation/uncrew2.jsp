									...
									<div style="text-align:left; border: 1px solid #BDBDBD; padding: 20px; margin-bottom: 15px;">
								 	...
								 	<table style="width:100%;  ">
								 		<tr style="height:40px;  border-top: 2px solid black;">
								 			<td style="width:200px; background:#353866; color: white;"><b style="color: white;">성명</b></td>
								 			<td style="text-align: left;"><input id="name" name="name" style="margin: 5px;" type="text"></td>
								 		</tr>
								 		<tr style="height:40px;">
								 			<td style="background:#353866; color: white;"><b style="color: white;">전화번호</b></td>
								 		...
								 		<tr style="height:40px;">
								 			<td style="background:#353866;"><b style="color: white;">이메일</b></td>
								 			<td style="text-align: left;"><input id="email" name="email" type="text" style="width:300px; margin: 5px;"></td>
								 		</tr>
								 		<tr style="height:40px;">
								 			<td style="background:#353866;"><b style="color: white;">비밀번호</b></td>
								 			<td style="text-align: left;"><input id="password" maxlength="5" name="password" style="margin: 5px;" type="password">※ 구입 시 입력한 비밀번호 5자리</td>
								 		</tr>
								 	</table>
								 	<button type="button" id="unCrew2Btn" style="font-weight:bold; font-size:15px; border-radius:5px; width:100px; height:30px; background: #353866; color: white; border: none;">확인</button>
								</div>
								</form>
							</header>
						</section>
