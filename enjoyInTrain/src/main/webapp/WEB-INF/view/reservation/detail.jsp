								...
								<div style="width: 1200px; text-align: center;">
								 	<table style="width:100%;  ">
								 		<tr style="height:40px; font-weight:bold; border-top: 2px solid black; background: #EAEAEA;">
								 			<td style="background: #273267; color: white;" colspan="9">승차권 예약현황</td>
								 		</tr>
								 		<tr style="height:40px; font-weight:bold; background: #EAEAEA;">
								 			<td style="background: #e8e8e8">승차일</td>
								 			<td style="background: #e8e8e8">열차번호</td>
								 			<td style="background: #e8e8e8">출발역</td>
								 			<td style="background: #e8e8e8">도착역</td>
								 			<td style="background: #e8e8e8">출발시간</td>
								 			<td style="background: #e8e8e8">도착시간</td>
								 			<td style="background: #e8e8e8">금액</td>
								 			<td style="background: #e8e8e8">인원</td>
								 			<td style="background: #e8e8e8">취소/환불</td>
								 		</tr>
								 		<c:forEach items="${list}" var="dto">
									 		<tr style="height: 40px;">
									 			...
									 			<td>${dto.count}</td>
									 			<td>
										 			<button type="button" style="border:none; background: #273267; color: white;" class="refundBtn" data-code="${dto.trCode}">환불하기</button>
									 			</td>
									 		</tr>
								 		</c:forEach>
								 	</table>
