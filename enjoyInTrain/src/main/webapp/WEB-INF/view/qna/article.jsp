...
<div style="width: 750px;">
	...
	<table style="width: 100%; margin: 0px auto 20px; border-spacing: 0px;">
		<tr height="45">
			<td width="400px" align="left"><c:if
					test="${sessionScope.crew.crewId=='a'}">
					<button type="button" class="btn"
						onclick="updateForm('${dto.qnaNum}');">답변달기</button>
				</c:if> <c:if test="${sessionScope.crew.crewId==dto.crewId}">
					<button type="button" class="btn"
						onclick="updateForm('${dto.qnaNum}');">질문수정하기</button>
				</c:if> <c:if
