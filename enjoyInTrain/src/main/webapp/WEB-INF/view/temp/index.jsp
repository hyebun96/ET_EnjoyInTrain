...
<html>
	<head>
		...
		<link rel="stylesheet" href="<%=cp%>/resorce/css/skel-noscript.css">
		<link rel="stylesheet" href="<%=cp%>/resorce/css/style.css">
		<link rel="stylesheet" href="<%=cp%>/resorce/css/style-desktop.css">
	</head>
	<body class="homepage">
